            ...
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="motherlastname" type="text" class="form-control @error('motherlastname') is-invalid @enderror" name="motherlastname" value="{{$usuario->motherlastname}}" required autocomplete="motherlastname" autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{$usuario->phone}}" required autocomplete="phone">
